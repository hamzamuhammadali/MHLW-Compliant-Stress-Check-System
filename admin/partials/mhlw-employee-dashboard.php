...
jQuery(document).ready(function($) {
    ...
    form.on('submit', function(e) {
        ...
        submitBtn.prop('disabled', true).val('<?php _e("Submitting...", "mhlw-compliant-stress-check-system"); ?>');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    showMessage(response.data.message, 'error');
                    submitBtn.prop('disabled', false).val('<?php _e("Submit Assessment", "mhlw-compliant-stress-check-system"); ?>');
                }
            },
            error: function() {
                showMessage('<?php _e("An error occurred. Please try again.", "mhlw-compliant-stress-check-system"); ?>', 'error');
                submitBtn.prop('disabled', false).val('<?php _e("Submit Assessment", "mhlw-compliant-stress-check-system"); ?>');
            }
        });
    });
    ...
    function showMessage(message, type) {
        ...
        messagesContainer.html('<div class="notice ' + messageClass + ' is-dismissible"><p>' + message + '</p></div>');
